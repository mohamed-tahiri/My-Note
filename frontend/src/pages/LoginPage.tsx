    ...
    <Box sx={{ 
      ...
      >
        ...
        <Box sx={{ textAlign: 'center', mb: 5 }}>
          <Box 
            sx={{ 
              width: 56, height: 56, bgcolor: 'primary.main', 
              borderRadius: '14px', mx: 'auto', mb: 3,
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              boxShadow: '0px 8px 16px rgba(37, 99, 235, 0.2)'
            }}
          >
            <Typography variant="h5" color="white" fontWeight={900}>N</Typography>
          </Box>
        ...
        <Stack component="form" onSubmit={handleSubmit} noValidate spacing={2.5}>
          <Box>
            <Typography variant="caption" sx={{ fontWeight: 700, ml: 1, color: 'text.secondary', textTransform: 'uppercase' }}>
              Email
            </Typography>
            <TextField
              required
