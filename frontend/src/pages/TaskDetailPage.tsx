...
export default function TaskDetailPage() {
    ...
    const currentStatus = task
        ? statusConfig[task.status as TaskStatusType] || statusConfig[TaskStatus.PENDING]
        : statusConfig[TaskStatus.PENDING];
                ...
                {task && (
                    <>
                        ...
                        <Grid container spacing={0} sx={{ height: 'calc(100vh - 80px)' }}>
                            ...
                            <Grid
                                size={{ xs: 12, md: 4 }}
                                sx={{ p: 4, bgcolor: alpha('#f8fafc', 0.5), overflowY: 'auto' }}
                            >
                                <Stack spacing={4}>
                                    <Box>
                                        <Typography
