...
export default function SettingsPage() {
    ...
    return (
        <Box maxWidth="md">
            ...
            <Paper sx={{ p: 4, borderRadius: '16px', mb: 3 }}>
                ...
                <Stack spacing={3}>
                    ...
                    <TextField
                        ...
                        defaultValue="admin@core-system.com"
                    />
                    ...
                    <FormControlLabel
                        control={<Switch defaultChecked />}
                        label="Reporting hebdomadaire par mail"
                    />
            ...
            >
                <Typography variant="h6" color="error" mb={1} fontWeight={700}>
                    Session
                </Typography>
                <Typography variant="body2" color="text.secondary" mb={3}>
                    Déconnectez-vous de votre compte administrateur pour mettre fin à votre session
                    actuelle.
                </Typography>
