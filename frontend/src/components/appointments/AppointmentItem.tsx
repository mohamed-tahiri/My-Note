...
import { Box, Chip, IconButton, Paper, Stack, Typography, Menu, MenuItem, ListItemIcon } from '@mui/material';
            ...
            <Stack direction={{ xs: 'column', sm: 'row' }} spacing={3} alignItems={{ sm: 'center' }}>
                ...
                <Box sx={{ 
                    ...
                    <Typography variant="caption" sx={{ fontWeight: 700, color: 'text.secondary', textTransform: 'uppercase' }}>
                        {new Date(appointment.startAt).toLocaleDateString('fr-FR', { month: 'short' })}
                    </Typography>
                ...
                <Box>
                    ...
                    <Menu
                        ...
                        PaperProps={{
                            sx: { borderRadius: '12px', minWidth: '150px', mt: 1, boxShadow: '0px 4px 20px rgba(0,0,0,0.08)' }
                        }}
                    >
                        <MenuItem onClick={() => { onEdit(appointment); handleClose(); }}>
                            <ListItemIcon><EditIcon fontSize="small" /></ListItemIcon>
                            <Typography variant="body2">Modifier</Typography>
                        </MenuItem>
                        <MenuItem onClick={() => { onDelete(appointment.id); handleClose(); }} sx={{ color: 'error.main' }}>
                            <ListItemIcon><DeleteOutlineIcon fontSize="small" sx={{ color: 'error.main' }} /></ListItemIcon>
                            <Typography variant="body2" fontWeight={600}>Supprimer</Typography>
                        </MenuItem>
                    </Menu>
                </Box>
            </Stack>
